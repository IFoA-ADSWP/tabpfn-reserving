...
| A6 | Small data is the family's strength (v1's ceiling was 1,000 rows; "TFMs excel on tiny- to medium-sized **IID** data") | Our own explanation is "40–60 rows is too few to learn development patterns". The source neither states a floor nor agrees: its tiny-data claim is explicitly qualified to **IID**, and our split is not. So it does not predict our negative, and it does not support our explanation either | **outside the evidence** |
